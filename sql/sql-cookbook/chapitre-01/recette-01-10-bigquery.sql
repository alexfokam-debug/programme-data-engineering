...
with orders as(
    ...
    from unnest([
        ...
        struct(102 as order_id, 'Bob' as customer, 80.0 as order_total),
        ...
        struct(106 as order_id, 'Frank' as customer, 90.0 as order_total),
        struct(107 as order_id, 'Grace' as customer, 300.0 as order_total),
        struct(108 as order_id, 'Heidi' as customer, 250.0 as order_total),
        struct(109 as order_id, 'Ivan' as customer, 70.0 as order_total),
...
select *
from orders
order by farm_fingerprint(cast(order_id as string))  
limit 5 
